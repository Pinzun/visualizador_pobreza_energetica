# services/asequibilidad_g_insuficiente.py
...
def calcular_indicador(filtro, session):
	resultado = session.query(
		AsequibilidadData.G_INSUFICIENTE
...
def obtener_valores_tabla(filtro, session):
	# Para esta tabla, se desplegará el gasto insuficiente
...
def obtener_indicador_g_insuficiente(filtro, session):
