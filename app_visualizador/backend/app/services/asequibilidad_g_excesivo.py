# services/asequibilidad_g_excesivo.py
...
def obtener_valores_tabla(filtro, session):
	# Para esta tabla, se desplegará el gasto excesivo
...
def obtener_indicador_g_excesivo(filtro, session):
