  ...
  return (
    <article className="notas-tecnicas">
      ...
      <div className="nt-body">
        ...
        <main className="nt-col nt-col--main">
          <section className="nt-callout">
            <h2>Definición resumida</h2>
            <p>
              La pobreza energética se refiere a la situación en la que un hogar
              no puede acceder a una cantidad suficiente de servicios
              energéticos esenciales para garantizar condiciones de vida dignas,
              ya sea por falta de recursos económicos o por ausencia de
              infraestructura adecuada. Este concepto incluye la energía
              necesaria para calefacción, refrigeración, iluminación, cocina y
              agua caliente sanitaria, entre otros usos básicos123. A nivel
              internacional, la definición más citada proviene de Brenda
              Boardman (1991), quien la describió como la incapacidad de un
              hogar para mantener una temperatura adecuada en la vivienda
              destinando menos del 10% de sus ingresos a energía. Sin embargo,
              enfoques más recientes, como los de Bouzarovski y Petrova (2015),
              la entienden como la imposibilidad de alcanzar un nivel social y
              materialmente necesario de servicios energéticos, afectando la
