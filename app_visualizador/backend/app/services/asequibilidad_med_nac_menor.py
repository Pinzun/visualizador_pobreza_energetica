# services/asequibilidad_med_nac_menor.py
...
def calcular_indicador(filtro, session):
	resultado = session.query(
		AsequibilidadData.MED_NAC_MENOR
...
def obtener_valores_tabla(filtro, session):
	# Para esta tabla, se desplegará el valor de la media nacional menor
...
def obtener_indicador_med_nac_menor(filtro, session):
